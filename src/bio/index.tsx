    ...
    <Container maxWidth="md" className="Bio-container">
      <Box component={Paper} p={2}>
        ...
        <p>
          ...
          children, having chosen the flute as her main instrument with recommendation of Helga Kuster and the American
          National Flute Association. Mira won her first prize in an international music festival called ‘The Voice of
          Asia’ at the age of ten. In the same year, she won the Soros foundation scholarship for the Central Music
          School of Moscow State Tchaikovsky Conservatory. During her study, she was awarded at many important
          competitions and festivals in Kazakhstan, Russia, Hungary, Latvia, Romania. After school, she was invited to
          work with the Symphony orchestra of the Kazakh State Philharmonic and won a presidential scholarship to study
          at the National Conservatory and also a DAAD-prize to study in Germany with Bettina Wilde and Renate
          Greiss-Armin.
        </p>
        <p>
        ...
        <p>
          Since 2010, she has worked with the Kazakh State symphony orchestra, “Eegeru” contemporary music ensemble, the
        ...
        <p>
          She took part in festivals such as Musikfestspiele Berlin, Zermatt, Nauryz XXI contemporary music festival,
